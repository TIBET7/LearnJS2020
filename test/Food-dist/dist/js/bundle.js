...
function slider(_ref) {
  ...
  var btnNext = document.querySelector(nextArrow);
  var btnPrev = document.querySelector(prevArrow);
  var current = document.querySelector(currentCounter);
  var total = document.querySelector(totalCounter);
  var slideIndex = 1; // First version of slider
  // const showSlides = (n) => {
  //     if (n > slides.length) {
  //         slideIndex = 1;
  //     }
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_7__["default"])('.timer', '2020-12-31');
});
